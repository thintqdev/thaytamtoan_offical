        ...
        <div class="dropdown">
              ...
              <div class="notification-item">
                <div class="notification-item-content">
                  ...
                  <div class="notification-item-content-right">
                    ...
                    <p class="notification-item-content-right-description">Đã đăng ký thi môn Toán vào ngày 20/10/2021
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" id="userDropdownMenu">
                ...
                <a class="dropdown-item" href="/result_exams.html"><i class="fa fa-graduation-cap mr-2"></i>Kết quả
                  thi</a>
                <a class="dropdown-item" href="/change_password.html"><i class="fa fa-key mr-2"></i>Đổi mật khẩu</a>
